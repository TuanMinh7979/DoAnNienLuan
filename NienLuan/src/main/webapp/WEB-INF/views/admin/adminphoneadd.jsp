    ...
    <div id="wrapper" style="margin:0 auto">
                ...
                <div id="cauhinhchitiet" style="display:flex">
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 ">
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>MÀU </label>
                                <input type="text" style="width:100px" class="form-control" name="mau">
                            </div>
      ...
      <div id="imgSection" class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
            ...
            <div id="imgArea">
                ...
                <div style="height:200px; width:100%; border:1px solid gray">
                    <p>Chưa có ảnh</p>
                </div>
...
function savePhone(data) {
    $.ajax({
        ...
        success: function(res) {
            ...
            alert("Đã thêm sản phẩm có id là " + res);
        },
